...
function ViewInterface:WaitMoveComplete(chess, start_x, start_y, target_x, target_y, speed, call_back)
	assert(GameStateMachine:IsWatching() == 1)
	local view_scene = SceneMgr:GetCurrentScene()
	return view_scene:MoveChessToPosition(chess, start_x, start_y, target_x, target_y, speed, call_back)
end
